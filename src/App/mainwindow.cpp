...
void MainWindow::CreateActions()
{
	...
	action_rectchoose_ = new QAction(tr("RectChoose"), this);
	action_rectchoose_->setStatusTip(tr("Choose a rect region"));
	connect(action_rectchoose_, &QAction::triggered, imagewidget_, &ImageWidget::ChooseRect);

	action_polygonchoose_ = new QAction(tr("PolygonChoose"), this);
	action_polygonchoose_->setStatusTip(tr("Choose a Polygon region"));
	connect(action_polygonchoose_, &QAction::triggered, imagewidget_, &ImageWidget::ChoosePolygon);

	action_Cut_ = new QAction(tr("GrabCut"), this);
...
void MainWindow::CreateMenus()
{
	...
	menu_edit_->addAction(action_rectchoose_);
	menu_edit_->addAction(action_polygonchoose_);
...
void MainWindow::CreateToolBars()
{
	...
	toolbar_file_->addAction(action_rectchoose_);
	toolbar_file_->addAction(action_polygonchoose_);
